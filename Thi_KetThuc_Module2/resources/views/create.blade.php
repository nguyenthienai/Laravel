...
@section('title', 'Quản Trị | Thêm mới bài viết')
@section('content')	
						...
						<div class="row" style="margin-bottom:40px">
							<div class="col-xs-8">
								...
								<div class="form-group" >
									...
									<textarea required name="tomtat" cols="100" rows="5"></textarea>
								...
								<input type="submit" name="edit" value="Thêm" class="btn btn-primary">
